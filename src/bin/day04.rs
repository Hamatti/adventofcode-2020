...
/// - `byr` (Birth year) is four digits and between 1920 and 2020, inclusive
...
mod tests {
    ...
    fn it_solves_part1_example() {
        let example_input = vec![
            String::from("ecl:gry pid:860033327 eyr:2020 hcl:#fffffd byr:1937 iyr:2017 cid:147 hgt:183cm"),
    ...
    fn it_validates_byr_correctly() {
        assert_eq!(validate_field(&String::from("byr"), &String::from("1919")), false);
        assert_eq!(validate_field(&String::from("byr"), &String::from("1920")), true);
        assert_eq!(validate_field(&String::from("byr"), &String::from("2002")), true);
        assert_eq!(validate_field(&String::from("byr"), &String::from("2003")), false);
    }

    #[test]
    fn it_validates_iyr_correctly() {
        assert_eq!(validate_field(&String::from("iyr"), &String::from("2009")), false);
        assert_eq!(validate_field(&String::from("iyr"), &String::from("2010")), true);
        assert_eq!(validate_field(&String::from("iyr"), &String::from("2020")), true);
        assert_eq!(validate_field(&String::from("iyr"), &String::from("2021")), false);
    }

    #[test]
    fn it_validates_eyr_correctly() {
        assert_eq!(validate_field(&String::from("eyr"), &String::from("2019")), false);
        assert_eq!(validate_field(&String::from("eyr"), &String::from("2020")), true);
        assert_eq!(validate_field(&String::from("eyr"), &String::from("2030")), true);
        assert_eq!(validate_field(&String::from("eyr"), &String::from("2031")), false);
    }

    #[test]
    fn it_validates_hgt_correctly() {
        assert_eq!(validate_field(&String::from("hgt"), &String::from("149cm")), false);
        assert_eq!(validate_field(&String::from("hgt"), &String::from("150cm")), true);
        assert_eq!(validate_field(&String::from("hgt"), &String::from("193cm")), true);
        assert_eq!(validate_field(&String::from("hgt"), &String::from("194cm")), false);
        
        assert_eq!(validate_field(&String::from("hgt"), &String::from("58in")), false);
    ...
    fn it_validates_hcl_correctly() {
        assert_eq!(validate_field(&String::from("hcl"), &String::from("ccc999")), false);
        assert_eq!(validate_field(&String::from("hcl"), &String::from("#ccc999")), true);
        assert_eq!(validate_field(&String::from("hcl"), &String::from("#000000")), true);
        assert_eq!(validate_field(&String::from("hcl"), &String::from("#abvc")), false);
    }

    #[test]
    fn it_validates_ecl_correctly() {
        assert_eq!(validate_field(&String::from("ecl"), &String::from("amb")), true);
        assert_eq!(validate_field(&String::from("ecl"), &String::from("blu")), true);
        assert_eq!(validate_field(&String::from("ecl"), &String::from("brn")), true);
        assert_eq!(validate_field(&String::from("ecl"), &String::from("gry")), true);
        assert_eq!(validate_field(&String::from("ecl"), &String::from("grn")), true);
        assert_eq!(validate_field(&String::from("ecl"), &String::from("hzl")), true);
        assert_eq!(validate_field(&String::from("ecl"), &String::from("oth")), true);
        assert_eq!(validate_field(&String::from("ecl"), &String::from("wrong")), false);
        assert_eq!(validate_field(&String::from("ecl"), &String::from("01234")), false);
    }

    #[test]
    fn it_validates_pid_correctly() {
        assert_eq!(validate_field(&String::from("pid"), &String::from("012345678")), true);
        assert_eq!(validate_field(&String::from("pid"), &String::from("1234")), false);
        assert_eq!(validate_field(&String::from("pid"), &String::from("01234567F")), false);
    }

    #[test]
    fn it_validates_cid_correctly() {
        assert_eq!(validate_field(&String::from("cid"), &String::from("012345678")), true);
        assert_eq!(validate_field(&String::from("cid"), &String::from("1234")), true);
        assert_eq!(validate_field(&String::from("cid"), &String::from("01234567F")), true);
        assert_eq!(validate_field(&String::from("cid"), &String::from("")), true);
    }
